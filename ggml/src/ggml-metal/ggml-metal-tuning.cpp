...
// A row is emitted only if its config is no slower than baseline at every sampled point of its bucket.
constexpr fa_entry_t fa_tuned_table[] = {
    { { GGML_METAL_DEVICE_M5, -1, 32, 32 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 40, 40 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 48, 48 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 64, 64 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 72, 72 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 80, 80 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 1, 96, 96 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 2, 96, 96 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 3, 96, 96 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 4, 96, 96 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 5, 96, 96 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 96, 64 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 112, 112 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 128, 128 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 1, 192, 192 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 2, 192, 192 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 3, 192, 192 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 4, 192, 192 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 5, 192, 192 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, -1, 192, 128 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 1, 256, 256 }, { 16, 8 } },
    { { GGML_METAL_DEVICE_M5, 2, 256, 256 }, { 16, 8 } },
    { { GGML_METAL_DEVICE_M5, 3, 256, 256 }, { 16, 8 } },
    { { GGML_METAL_DEVICE_M5, 4, 256, 256 }, { 16, 4 } },
    { { GGML_METAL_DEVICE_M5, 5, 256, 256 }, { 16, 4 } },
};
