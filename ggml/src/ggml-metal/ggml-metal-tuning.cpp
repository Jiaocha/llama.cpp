...
// A row wins at large launches and is no slower than baseline at every sampled launch of tiles_min wide tiles or more.
constexpr fa_entry_t fa_tuned_table[] = {
    ...
    { { GGML_METAL_DEVICE_M5, 2, 96, 96 }, { 16, 8 }, 128 },
