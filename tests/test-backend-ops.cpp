...
// Conv_2D test cases
 ...
 // A deep layer of a ConvNet, several images in the batch
    ...
    // GLM-4.7 Flash: exact MLA shape that dispatches to MKL FA for prompt batches.
    test_cases.emplace_back(new test_flash_attn_ext(576, 512, 1, {20, 1}, 1024, 32, true, false, 0, 0,
